...
class DataForm:
    ...
    async def get_usvisa_data(self):
        ...
        self.education_of_employee = form.get(
            "education_of_employee"
        )

        self.has_job_experience = form.get(
            "has_job_experience"
        )

        self.requires_job_training = form.get(
            "requires_job_training"
        )

        self.no_of_employees = form.get(
            "no_of_employees"
        )

        self.company_age = form.get(
            "company_age"
        )

        self.region_of_employment = form.get(
            "region_of_employment"
        )

        self.prevailing_wage = form.get(
            "prevailing_wage"
        )

        self.unit_of_wage = form.get(
            "unit_of_wage"
        )

        self.full_time_position = form.get(
            "full_time_position"
        )
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        usvisa_data = USvisaData(
            ...
            education_of_employee=(
                form.education_of_employee
            ),

            has_job_experience=(
                form.has_job_experience
            ),
        ...
        usvisa_df = (
            usvisa_data.get_usvisa_input_data_frame()
        )
